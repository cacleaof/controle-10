...
@section('content')
                ...
                <!-- form start -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <p><strong>Devolução: </strong> {{$consult->resposta}} </p>
            ...
            <div class="box box-primary">
                ...
                <form role="form">
                    ...
                    <div class="box-header">
                        <a href="{{ route('admin.consult.deletar', ['sid' => $sid]) }}" class="btn btn-danger"><i class="fas fa-shopping-cart"></i>Deletar</a>
                    </div>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Tirar a sAvaliação da Satisfação</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
