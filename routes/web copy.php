...
Route::group(['middleware' => ['auth'], 'namespace' => 'Admin', 'prefix' => 'admin',], function(){
		...
		Route::get('lista', 'UserControl@lista')->name('admin.cadastro.lista');
		...
		Route::get('consult/deletar', 'ConsultController@deletar')->name('admin.consult.deletar');
	...
	Route::get('store_p', 'ProjControl@store_p')->name('admin.proj.store_p');
	...
	Route::get('diario', 'ProjControl@diario')->name('admin.proj.diario');

	Route::get('sol_atv', 'ProjControl@sol_atv')->name('admin.proj.sol_atv');

	Route::post('diario', 'ProjControl@diario')->name('admin.proj.diario');
	...
	Route::post('store_diario', 'ProjControl@store_diario')->name('admin.proj.store_diario');
	...
	Route::get('n_task', 'ProjControl@n_task')->name('admin.proj.n_task');
	...
	Route::post('atualizar-perfil', 'Admin\UserControl@profileUpdate')->name('profile.update')->middleware('auth');

	//Route::get('/saida', 'Admin\ConsultController@saida')->name('admin.consult.saida')->middleware('auth');

	Route::get('meu-perfil', 'Admin\UserControl@profile')->name('profile')->middleware('auth');

	//Route::get('/', 'Site\SiteController@index')->name('home');

	Route::get('/', function(){  return view('auth.login'); });

	Route::get('/finalizadas', 'Admin\ConsultController@finalizada')->name('admin.home.finalizada')->middleware('auth');

	//Route::get('/post', 'Site\SiteController@post')->name('post')->middleware('auth');

	Route::post('/duvida', 'Site\SiteController@duvida')->name('admin.home.duvida')->middleware('auth');
